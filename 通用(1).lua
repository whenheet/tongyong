...
Notify("大司马脚本", "作者：大司马", "rbxassetid://108228172425291", 3)
...
local Window = Library:new("大司马｜通用脚本")
...
credis:Label("正在使用通用脚本，目前不支持此服务器，可以加入以下服务器游玩")
...
-- 通用标签
local creds = Window:Tab("通用", '16060333448') -- 修正window为Window
